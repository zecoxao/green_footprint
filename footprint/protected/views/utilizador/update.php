...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . Utilizador::label(2), 'icon' => 'list', 'url' => array('index')),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . Utilizador::label(); ?> <?php echo CHtml::encode($model) ?></legend>
