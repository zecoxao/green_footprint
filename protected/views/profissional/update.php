...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . Profissional::label(2), 'icon' => 'list', 'url' => array('index')),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . Profissional::label(); ?> <?php echo CHtml::encode($model) ?></legend>
